package com.infinityscaledintelligent.socket;

import java.io.*;
import java.net.*;

public class ArduinoSocketClientIntegrationTest {
	...
	public static void main(String argv[]) throws Exception {
		...
		Socket clientSocket = new Socket(serverIP, serverPort);// making the
																// socket
																// connection
		System.out.println("Connected to:" + serverIP + " on port:"
				+ serverPort);// debug
		...
		msgToServer = "test.D13.1";// Message tha will be sent
		...
		System.out.println("recieved from Arduino-Server: " + msgFromServer);// print
																				// the
																				// answer
